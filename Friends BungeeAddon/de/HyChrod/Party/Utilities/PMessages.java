...
public enum PMessages {
	...
	CMD_INVITE_CREATE_PARTY("PartyMessages.Commands.InviteCommand.CreateParty"),
	...
	private void loadMessage(Configuration cfg, String prefix) {
	...
	public static void loadAll(String prefix) {
		Configuration cfg = FileManager.getConfig("","Messages.yml");
