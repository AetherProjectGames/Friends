...
public class Friends extends JavaPlugin {
	...
	public void onEnable() {
		...
		if(FileManager.MYSQL.getConfig().getBoolean("Enable") || Configs.BUNGEEMODE.getBoolean()) {
			...
			Bukkit.getConsoleSender().sendMessage(prefix + " §aConnected to MySQL!" + (Configs.BUNGEEMODE.getBoolean() ? " <BungeeMode>" : ""));
		}
	...
	public static boolean isMySQL() {
		return (smgr != null && smgr.isConnected()) || Configs.BUNGEEMODE.getBoolean();
	}
